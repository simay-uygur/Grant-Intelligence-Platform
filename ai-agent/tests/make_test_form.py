...
form.textfield(name="org_name", x=220, y=height - 145,
               width=250, height=20, borderWidth=1)

# Field 2: Project goal
c.drawString(72, height - 180, "Project goal:")
form.textfield(name="project_goal", x=220, y=height - 185,
               width=250, height=20, borderWidth=1)

# Field 3: Budget
c.drawString(72, height - 220, "Budget (EUR):")
form.textfield(name="budget", x=220, y=height - 225,
               width=250, height=20, borderWidth=1)

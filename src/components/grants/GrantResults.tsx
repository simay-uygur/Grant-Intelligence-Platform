  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <div>
          <h3 className="text-sm font-semibold text-foreground">Top 3 matched grants</h3>
    ...
    <article className="rounded-2xl border bg-card p-5 text-card-foreground shadow-sm transition-shadow hover:shadow-md">
      ...
      <CardContent className="p-0">
        ...
        <dl className="mt-4 grid grid-cols-2 gap-3 text-xs lg:grid-cols-4">
          ...
          <Item label="Eligible" value={grant.eligibleCountries.slice(0, 2).join(", ")} />
        </dl>
      ...
      <CardFooter className="mt-5 flex flex-wrap items-center gap-2 p-0">
        ...
        <Button
          ...
          className="ml-auto rounded-lg bg-brand text-white shadow-sm hover:bg-brand/90"
        >
          Start application
        </Button>
      </CardFooter>

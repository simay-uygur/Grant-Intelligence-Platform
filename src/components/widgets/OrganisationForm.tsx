...
export function OrganisationForm({ initial, disabled, onSubmit }: Props) {
  ...
  return (
    <div ref={stepRef} className="rounded-2xl border border-border bg-card p-5 shadow-sm">
...
const textareaCls = `${inputCls} min-h-[72px] resize-y [overflow-wrap:anywhere] break-words`;
